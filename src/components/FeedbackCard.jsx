...
const FeedbackCard = ({content, name, title, img}) => (
  ...
  <div className="  border-2 border-black flex justify-between flex-col px-10 py-12 rounded-[20px] max-w-[370px] md:mr-10 sm:mr-5 mr-0 my-5 feedback-card">
  
        <Image src={quotes} alt="double_quotes" className="w-[42px] h-[40px] object-contain " />
