...
const Hero = () => {
  return (
    <section
      id="Home"
      className="lg:py-0 relative w-screen h-[70vh] min-h-[540px] max-h-[940px]"
    >
      <Image
      ...
      <div className=" flex lg:flex-row flex-col justify-center items-center h-[70vh] min-h-[700px] max-h-[940px]">
        <div className=" mx-16 text-center  ">
          <h2 className="leading-6 text-[#FFD700] font-raleway font-bold text-[18px] sm:text-[28px]">
            Revive Renew & Rejoice
          </h2>
          <h1 className="leading-8 text-white py-4 font-raleway font-bold text-[26px] sm:text-[36px]">
