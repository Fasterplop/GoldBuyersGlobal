 ...
 <Head>
  ...
  <Layout>
    ...
    <section id="About" className="sm:px-16 px-6 text-justify py-6">
      ...
      In recent years the gold market has provided a unique opportunity for people to cash 
      in on their unwanted jewelry. So in 2011 we decided to take our 30 plus years of 
      experience in the jewelry industry and establish a company that is personal, private,
       and honest.<span className="font-semibold"> A company that is easy to do business with.</span>  No gimmicks! 
      </p>


      <p className=" my-2 text-[16px] sm:text-[20px] font-montserrat leading-16 text-[#444444]">
      This drive to make people comfortable when dealing with us comes from learning
       a long time ago that the number one asset a company can have is the client. 
       Providing the best possible value and service is top priority for us and we are 
